...
class EventsController extends Controller
{
    public function index()
    {
        ...
        $events = Event::where('start_date', '>=', $currentDate)->orderBy('start_date', 'asc')->where('status', 'publish')->get()->map(function ($event) use ($currentDate, $option) {
    ...
    public function admin_events_index(Request $request)
    {
        ...
        $events = Event::orderBy($order_by ? $order_by : 'start_date', $order ? $order : 'asc')->get();
        $option = EventsOption::where('name', 'attend_duration')->first();
