                ...
                <WOW animation='fadeIn'>
                    <div className="blogs-section py-20 lg:py-40">
                        ...
                        <div className="link  pt-24 text-center">
                            <button className="bg-[#f5cd06] more-links-posts text-[#0f0f0f] shadow-lg px-10 py-4 font-bold text-lg rounded-full "><Link href='/blogs'>View More Posts</Link></button>
                        </div>
                    </div>
                </WOW>
            </div>
