    ...
    return (
        <Guest user={auth?.user}>
            <Head>
                ...
                <meta
                    name="descriptions"
                    content="Be informed and stay updated with the latest news and features from and about the Members Church of God International."
                />
            </Head>
