                    ...
                    <div className="modal-content pt-6">
                        <form onSubmit={addSubmit}>
                            <div className="form-item mb-4">
                                <InputLabel value="Category Title" className='mb-1 font-dmsans' />
                                <TextInput
                                    id="title"
                                    type="text"
                                    name="title"
                            ...
                            <div className="form-item mb-4">
                                <InputLabel value="Category Slug" className='mb-1 font-dmsans' />
                                <TextInput
                                    id="slug"
                                    type="text"
                                    name="slug"
                            ...
                            <div className="form-item mb-4">
                                <InputLabel value="Category Description" className='mb-1 font-dmsans' />
                                <textarea
                                    id="description"
                                    name="description"
                                    rows="10"
                            ...
                            <div className="form-item mb-4">
                                <InputLabel value="Category Status" className='mb-1 font-dmsans' />
                                <select
                                    name="status"
                                    id="status"
                                    className='border-gray-300 rounded-sm w-full font-dmsans placeholder:font-dmsans focus:border-yellow-500 focus:ring-0'
