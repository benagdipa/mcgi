...
export default function BlogQuillEditorEdit({ auth, item, categories, tags, csrf_token }) {
    const { data, setData, post, processing, errors, reset } = useForm({
        ...
        allow_comments: item.allow_comments === undefined ? true : item.allow_comments,
    ...
    const [isScheduled, setIsScheduled] = useState(item.status === 'scheduled');
