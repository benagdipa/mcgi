...
import { FaImage, FaCalendarAlt, FaSave, FaArrowLeft, FaTags, FaFolder, FaEye, FaSitemap, FaComments, FaStar } from "react-icons/fa";
import Flatpickr from "react-flatpickr";
import "flatpickr/dist/themes/material_blue.css";

export default function BlogEditor({ auth, categories, tags, csrf_token }) {
    ...
    const initializeEditor = () => {
        editorRef.current = new EditorJS({
            ...
            onChange: async () => {
                ...
                if (!data.excerpt) {
                    const plainText = extractPlainTextFromEditor(content);
                    if (plainText) {
    ...
    const extractPlainTextFromEditor = (content) => {
                                    ...
                                    <div className="lg:col-span-3 space-y-6">
                                        <Card>
                                            ...
                                            <div className="mb-4">
                                                ...
                                                <div className="mt-1 rounded-md border min-h-80">
                                                    <div id="editorjs" className="prose max-w-none p-4"></div>
                                                </div>
