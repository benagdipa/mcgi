...
export default function Sidebar({ current }) {
    ...
    return (
            ...
            <Card className="rounded-none xl:bg-[#212b36] border-b-2 xl:border-b-[0]  text-white shadow-none">
                <div className="desktop-view hidden xl:block">
                ...
                <div className="mobile-view  xl:hidden w-11/12 mx-auto flex justify-between  flex-row">
                    <div className="mb-2 bg-white p-4 ">
                        <ApplicationLogo />
                    </div>
                    ...
                    <div className={`${!toggle ? "hidden" : 'flex'} bg-[#212b36] side-menu ptphg-4 absolute left-0 top-[92px] h-screen w-[190px] md:top-[87px]`}>
                        <List className='text-white'>
                            <Link href={route('dashboard')} className={`${currentRoute === 'dashboard' ? 'bg-blue-gray-50/50 rounded-lg' : ''}`}>
                                <ListItem>
                                    <ListItemPrefix><IconCategory strokeWidth={1.2} /></ListItemPrefix>
